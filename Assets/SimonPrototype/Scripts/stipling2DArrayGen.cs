...
public class stipling2DArrayGen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        return2DArray = new Texture2DArray(iTexH, iTexH, numTones, TextureFormat.RGB24, true);
        for (int i=0; i< numTones; i++) {
            Graphics.CopyTexture(inputTexture, 0, 0, i*iTexH, 0, iTexH, iTexH, return2DArray, i, 0, 0, 0);
        }
        return2DArray.Apply();
        UnityEditor.AssetDatabase.CreateAsset(return2DArray, "Assets/"+fileName+".asset");
    }
